...
class UWidget* UAthenaSpectatorHUD_C::PopContentWidgetInternal(const struct FContentPushState& State, class UWidget* CallFunc_PopWigdet_ReturnValue)
{
...
void UAthenaSpectatorHUD_C::SetCursorModeContent(class UUserWidget* CustomWidget, class FName& ActionName, class UUserWidget* CursorWidget, bool CallFunc_IsValid_ReturnValue, class UPanelSlot* CallFunc_AddChild_ReturnValue)
{
	static auto Func = Class->GetFunction("AthenaSpectatorHUD_C", "SetCursorModeContent");

	Params::UAthenaSpectatorHUD_C_SetCursorModeContent_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaSpectatorHUD_C", "ShowGameOverLayer");

	Params::UAthenaSpectatorHUD_C_ShowGameOverLayer_Params Parms;
...
void UAthenaSpectatorHUD_C::GamePhaseChanged(enum class EAthenaGamePhase GamePhase)
{
	static auto Func = Class->GetFunction("AthenaSpectatorHUD_C", "GamePhaseChanged");

	Params::UAthenaSpectatorHUD_C_GamePhaseChanged_Params Parms;
